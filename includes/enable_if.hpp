...
/*   Updated: 2022/03/02 15:45:11 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace   ft{
    ...
    template<>
    struct is_integral<short>{static const bool value = false;};

    template<>
    struct is_integral<long>{static const bool value = false;};

    template<>
    struct is_integral<long long>{static const bool value = false;};
    ...
    template<>
    struct is_integral<unsigned long>{static const bool value = false;};

    template<>
    struct is_integral<unsigned long long>{static const bool value = false;};
